...
function Navbar() {
    ...
    return (
    <nav className='box-border absolute w-screen max-w-screen overflow-x-scroll bg-gray-900 z-20'>
        ...
        <ul className='flex space-x-3 p-2 bg-black border-b border-b-slate-800'>
